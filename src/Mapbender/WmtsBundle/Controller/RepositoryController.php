...
class RepositoryController extends Controller
{
    ...
    public function createAction()
    {
        ...
        if ($form->isValid()) {
            ...
            $proxy_query = ProxyQuery::createFromUrl(trim($wmtssource_req->getOriginUrl()), $wmtssource_req->getUsername(), $wmtssource_req->getPassword());
...
//            $this->saveLayer($this->getDoctrine()->getManager(), $rootlayer);
            ...
            return $this->redirect($this->generateUrl(
                        ...
                        "sourceId" => $wmtssource->getId()), true));
        }
